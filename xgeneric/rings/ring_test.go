...
func createRing() *Ring[*RingPojo] {
	r := NewRingOf(NewRingPojo("matt"), NewRingPojo("xml"), NewRingPojo("ant_miracle"),
		NewRingPojo("michael"), NewRingPojo(""), NewRingPojo("ryan"))
	return r
}

func createRingPojoArray() []*RingPojo {
	return xarray.AsList(NewRingPojo("matt"), NewRingPojo("xml"), NewRingPojo("ant_miracle"),
		NewRingPojo("michael"), NewRingPojo(""), NewRingPojo("ryan"))
}

func TestNewRing(t *testing.T) {
	Convey("TestNewRing", t, func() {
		r := NewRing[*RingPojo](10)
...
func step[E any](r *Ring[E], step int) (*Ring[E], bool) {
	if r == nil {
		return nil, false
	}
	ret := r
