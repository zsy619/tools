...
/**
 * @description: 写入文件,保存
 * @param {string} path 存储路径，如 uploads/icon
 * @param {string} base64_image_content base64编码的图片内容
 * @param {bool} datePath 是否按日期创建目录，如 2018-01-01，则最终存储路径 uploads/icon/2018-01-01
 * @return string error
 */
